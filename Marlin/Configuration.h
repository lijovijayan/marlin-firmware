...
// #define Z_CLEARANCE_FOR_HOMING     // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#define X_BED_SIZE 10      // Minimal value to pass checks
#define Y_BED_SIZE 10      // Minimal value to pass checks
